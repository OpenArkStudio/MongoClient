...
bool AFCMongoDriver::Connect(const std::string& strDBName, const std::string& strIPPort, const std::string& strUserName, const std::string&strPassword)
{
    if(bEnable == true)
    {
        return true;
...
const std::string AFCMongoDriver::MakeMongoUrl(const ConnectInfo& xinfo)
{
    std::string strUri;
    strUri += "mongodb://";
    ...
    {
        std::string strMinPoolSize;
        std::string strMaxPoolSize;
        Ark_to_str(strMinPoolSize, xinfo.nMinPoolSize);
        Ark_to_str(strMaxPoolSize, xinfo.nMaxPoolSize);
...
const std::string& AFCMongoDriver::GetMongoUrl()
{
